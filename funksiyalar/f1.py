...
highest_paid_employee = max(data, key=lambda x: float(x["salary"].replace("$", "")))
print(f"NAME: {highest_paid_employee['full_name']}")
print(f"COMPANY NAME: {highest_paid_employee['company']}")
print(f"JOB POSITION: {highest_paid_employee['position']}")
